...
export function OpenInV0Cta({ className }: React.ComponentProps<'div'>) {
    return (
        <div className={cn('group relative flex flex-col gap-2 rounded-lg border p-4 text-sm', className)}>
            ...
            <div>Vercel provides tools and infrastructure to deploy apps and features at scale.</div>
